...
public class EventUtil {
    ...
    public static List<Event> getAllEvents() {
        ...
        for (Map<String, AttributeValue> item: scanResult.getItems()) {
            String eventName = String.valueOf(item.get("event_name").getS());
            String eventDate = String.valueOf(item.get("event_date").getS());
            int numAliyahs = Integer.valueOf(item.get("num_aliyahs").getN());
            int numAliyahsTaken= Integer.valueOf(item.get("num_aliyahs_taken").getN());
